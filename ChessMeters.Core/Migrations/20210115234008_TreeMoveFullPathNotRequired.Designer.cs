...
namespace ChessMeters.Core.Migrations
{
    ...
    [Migration("20210115234008_TreeMoveFullPathNotRequired")]
    partial class TreeMoveFullPathNotRequired
    {
            ...
            modelBuilder.Entity("ChessMeters.Core.Entities.TreeMove", b =>
                {
                    ...
                    b.Property<bool>("Color")
                        ...
                        .HasComputedColumnSql("(LENGTH(FullPath) - LENGTH(REPLACE(FullPath, ' ', ''))) / 2 <> 0");
