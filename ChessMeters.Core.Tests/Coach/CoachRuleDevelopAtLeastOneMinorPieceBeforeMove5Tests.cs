...
namespace ChessMeters.Core.Coach.Tests
{
    ...
    {
        [Fact]
        public void AnalyzeGame_Should_Analyze_A_Basic_Game_Develop_At_Least_1_Minor_Before_M5_1()
        {
            ...
            {
                new CoachRuleDevelopAtLeaastOneMinorPieceBeforeMove5White(),
                new CoachRuleDevelopAtLeaastOneMinorPieceBeforeMove5Black()
            };
        ...
        [Fact]
        public void AnalyzeGame_Should_Analyze_A_Basic_Game_Develop_At_Least_1_Minor_Before_M5_2()
        {
